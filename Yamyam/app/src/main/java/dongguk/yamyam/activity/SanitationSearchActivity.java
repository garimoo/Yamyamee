 ...
 */
public class SanitationSearchActivity extends AppCompatActivity {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(SanitationSearchActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(AppConfig.URL_SANI_SEARCH);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                Toast.makeText(SanitationSearchActivity.this, "검색 결과가 존재하지 않습니다.", Toast.LENGTH_LONG).show();
            }else{
                ...
                try {
                    ...
                    Toast.makeText(SanitationSearchActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(SanitationSearchActivity.this, result.toString(), Toast.LENGTH_LONG).show();
                }
            }
        }
    }
