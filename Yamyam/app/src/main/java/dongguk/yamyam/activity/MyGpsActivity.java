...
import dongguk.yamyam.store.AdapterDistance;
...
public class MyGpsActivity extends AppCompatActivity {
    ...
    private AdapterDistance mAdapter;
            ...
            if(result.equals("no rows")) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        DetailGpsActivity myGps = new DetailGpsActivity();
                        ...
                        storeData.storeDistance = myGps.returnDistance();
                        /********************************************************************/
                    ...
                    mAdapter = new AdapterDistance(MyGpsActivity.this, data);
                    mRVStore.setAdapter(mAdapter);
                    mRVStore.setLayoutManager(new LinearLayoutManager(MyGpsActivity.this));

                } catch (JSONException e) {
                    // You to understand what actually error is and handle it appropriately
                    Toast.makeText(MyGpsActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(MyGpsActivity.this, result.toString(), Toast.LENGTH_LONG).show();
                }
            }
        }
    }
