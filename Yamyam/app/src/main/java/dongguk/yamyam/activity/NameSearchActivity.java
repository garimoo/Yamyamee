...
public class NameSearchActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) NameSearchActivity.this.getSystemService(Context.SEARCH_SERVICE);
        if (searchItem != null) {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(NameSearchActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(AppConfig.URL_NAME_SEARCH);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                Toast.makeText(NameSearchActivity.this, "검색 결과가 존재하지 않습니다.", Toast.LENGTH_LONG).show();
            }else{
                ...
                try {
                    ...
                    Toast.makeText(NameSearchActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(NameSearchActivity.this, result.toString(), Toast.LENGTH_LONG).show();
                }
            }
        }
    }
